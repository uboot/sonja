...
from public.api import build, channel, ecosystem, general, profile, repo, user, recipe, commit, package, run,\
    log_line, github, configuration
...
router.include_router(configuration.router, tags=["Configuration"])
